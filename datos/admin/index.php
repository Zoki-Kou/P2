...
<body class="login" style="background: linear-gradient(70deg, gray, white, Darkgray);">
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
			<a href="../../index.php">	<h2 style="font-weight: 600;color: #000;">ADMIN LOGIN</h2></a>
			</div>
			...
			<div class="box-login">
				<form class="form-login" method="post">
					<fieldset>
						...
						<p>
							Ingrese Usuario y Contraseña para Iniciar Sesion<br />
