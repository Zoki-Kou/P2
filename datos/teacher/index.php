...
if(isset($_POST['submit']))  {
	$ret=mysqli_query($con,"SELECT * FROM docente WHERE correo='".$_POST['username']."' and password='".$_POST['password']. "'");
...
<html lang="en">
	...
	<body class="login" style="background: silver;">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
				<a href="../../index.php">	<h2 style="font-weight: 600;color: #000;">| Docente Login  |</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> MSH</span>. <span>Datos Protegidos</span>
					</div>
