	...
	<body class="login" style="background: linear-gradient(70deg, blue, white, blue);">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2 style="font-weight: 600;color: #000;">Inicio Sesion Estudiante</h2></a>
				</div>
						...
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="email" class="form-control" name="username" placeholder="Usuario" required>
